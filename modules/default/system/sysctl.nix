{
  flake.nixosModules.default =
    ...
    let
      cfg = config.freedpom.system.sysctl;
    in
    {
      options.freedpom.system.sysctl = {
      ...
      config = lib.mkIf cfg.cachyos {
        boot.kernel.sysctl = {
          ...
          # The value controls the tendency of kernel to reclaim the memory which is used for caching of directory and inode objects (VFS cache).
