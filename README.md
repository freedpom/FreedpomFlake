...
![nix-lock-update-status](https://img.shields.io/github/actions/workflow/status/freedpom/FreedpomFlake/nix-flake-lock.yml?logo=nixos&logoColor=white&label=Lock%20Update&labelColor=%23779ECB)
